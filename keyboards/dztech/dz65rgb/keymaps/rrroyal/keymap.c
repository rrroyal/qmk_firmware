...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_65_ansi(
        ...
        KC_LSFT,                   KC_MPRV, KC_MPLY, KC_MNXT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_HOME, KC_P8,   KC_PGDN,
        XXXXXXX,          XXXXXXX, XXXXXXX,                            XXXXXXX,                   XXXXXXX, XXXXXXX, MO(2),   KC_P4,   KC_P2,   KC_P6
    ),
    [2] = LAYOUT_65_ansi(
