...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_65_ansi(
        ...
        XXXXXXX,          RGB_TOG, RGB_MOD, RGB_VAD, RGB_VAI, RGB_SPD, RGB_SPI, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_PAUS, XXXXXXX, KC_VOLD,
        CTL_T(KC_CAPS),   RGB_HUD, RGB_HUI, RGB_SAD, RGB_SAI, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,          XXXXXXX, KC_PGUP,
        KC_LSFT,                   KC_MPRV, KC_MPLY, KC_MNXT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_HOME, KC_VOLU, KC_PGDN,
        XXXXXXX,          XXXXXXX, XXXXXXX,                            XXXXXXX,                   XXXXXXX, XXXXXXX, MO(2),   KC_MPRV, KC_VOLD, KC_MNXT
    ),
    [2] = LAYOUT_65_ansi(
        ...
        XXXXXXX,          XXXXXXX, XXXXXXX,                            XXXXXXX,                   XXXXXXX, XXXXXXX, XXXXXXX, KC_P4,   KC_P2,   KC_P6
    )
};
